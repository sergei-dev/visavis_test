...
/* harmony import */ var _modules_toggleMenu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/toggleMenu */ "./src/js/modules/toggleMenu.js");
/* harmony import */ var _modules_scrollLinks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/scrollLinks */ "./src/js/modules/scrollLinks.js");
/* harmony import */ var _modules_vueInit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/vueInit */ "./src/js/modules/vueInit.js");
/* harmony import */ var _modules_contactForm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/contactForm */ "./src/js/modules/contactForm.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var toggleMenu = function toggleMenu() {
    var $headerBurger = document.querySelector('.js-burger');
    var $headerMenu = document.querySelector('.js-menu');
  ...
  _modules_initSwiper__WEBPACK_IMPORTED_MODULE_1__["default"].init(); // validation contacts form
  // validationContactsForm.init();
  // lines animation init

  new wow_js__WEBPACK_IMPORTED_MODULE_0___default.a().init();
  Object(_modules_vueInit__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_toggleMenu__WEBPACK_IMPORTED_MODULE_2__["default"])();
  toggleMenu();
  Object(_modules_scrollLinks__WEBPACK_IMPORTED_MODULE_3__["default"])();
  _modules_contactForm__WEBPACK_IMPORTED_MODULE_5__["default"].init();
});
...
var contactForm = /*#__PURE__*/function () {
  ...
  _createClass(contactForm, [{
    ...
    key: "validateHandlers",
    value: function validateHandlers() {
      var _this = this;
      ...
      this.$form.addEventListener('submit', function (event) {
        ...
        _this.$inputs.forEach(function (item) {
          _this.validateForm(item);
        });

        if (_this.$name.value && _this.$phone.value && _this.$email.value) {
          _this.requestForm();
        }
      });
    ...
    value: function requestForm() {
      ...
      var url = "/form-sending";
      this.amount = this.$range.value;
      this.check = this.$checkbox.checked ? this.$checkbox.value : '';
      var params = "name=" + this.name + "&phone=" + this.phone + "&email=" + this.email + "&amount=" + this.amount + "&check=" + this.check;
...
swiper_js_swiper_esm_js__WEBPACK_IMPORTED_MODULE_0__["Swiper"].use([swiper_js_swiper_esm_js__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper_js_swiper_esm_js__WEBPACK_IMPORTED_MODULE_0__["Pagination"]]);

var initSwiper = /*#__PURE__*/function () {
  function initSwiper(container, pagination, prevEl, nextEl) {
    _classCallCheck(this, initSwiper);
  ...
  _createClass(initSwiper, [{
    ...
    value: function init() {
      ...
      var swiperAbout = new swiper_js_swiper_esm_js__WEBPACK_IMPORTED_MODULE_0__["Swiper"](this.$container, {
        speed: 500,
        navigation: {
          nextEl: this.$nextEl,
          prevEl: this.$prevEl
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return toggleFooterMenu; });
function toggleFooterMenu() {
  var menuWrap = document.querySelector('.footer__wrap');
  ...
  var hideAll = function hideAll() {
    var toggleBtn = menuWrap.querySelectorAll('.js-toggle-menu');
    var togglesSub = menuWrap.querySelectorAll('.js-sub-menu');

    for (var i = 0; i < toggleBtn.length; i++) {
      toggleBtn[i].classList.remove('active');
    }

    for (var _i = 0; _i < togglesSub.length; _i++) {
      togglesSub[_i].style.maxHeight = '0';

      togglesSub[_i].classList.remove('active');
    }
  };

  var showMenu = function showMenu(list) {
...
/* harmony import */ var vue_slide_bar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue-slide-bar */ "./node_modules/vue-slide-bar/lib/vue-slide-bar.min.js");
/* harmony import */ var vue_slide_bar__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(vue_slide_bar__WEBPACK_IMPORTED_MODULE_2__);



function progressInit() {
  Vue.component('vue-range', vue_slide_bar__WEBPACK_IMPORTED_MODULE_2___default.a);
  new Vue({
    el: '#progress',
    data: {
      progressItems: [{
  ...
  new Vue({
    ...
    data: {
      slider: {
        value: 3000,
        data: [500, 1500, 2500, 3500, 4500, 5500, 6500],
        range: [{
          label: '500 грн'
        }, {
          label: '1500 грн'
...
module.exports = __webpack_require__(/*! /Applications/Документы/front-end/projects/visavis_test/src/js/main.js */"./src/js/main.js");
